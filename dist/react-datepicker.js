      ...
      return (
        (o.renderOptions = function() {
          return o.state.monthYearsList.map(function(e) {
            var n = e.valueOf(),
              r = F(o.props.date, e) && P(o.props.date, e);
            return t.createElement(
              "div",
              {
                className: r
      ...
      function n() {
        ...
        return (
          ...
          (o.onChange = function(e) {
            o.toggleDropdown();
            var t = d(parseInt(e));
            (F(o.props.date, t) && P(o.props.date, t)) || o.props.onChange(t);
          }),
          (o.toggleDropdown = function() {
            return o.setState({ dropdownVisible: !o.state.dropdownVisible });
          }),
      ...
      function n(r) {
        ...
        return (
          ...
          (o.handleDropdownFocus = function(e) {
            ge(e.target) && o.props.onDropdownFocus();
          }),
          ...
          (o.changeMonth = function(e) {
            o.setState({ date: D(m(o.state.date), e) }, function() {
              return o.handleMonthChange(o.state.date);
            });
          }),
          (o.changeMonthYear = function(e) {
            o.setState({ date: b(D(m(o.state.date), k(e)), C(e)) }, function() {
          ...
          (s.handleSelect = function(e, t) {
            s.setState({ preventFocus: !0 }, function() {
              ...
              !s.props.shouldCloseOnSelect || s.props.showTimeSelect
                ? s.setPreSelection(e)
                : s.props.inline ||
                  (s.props.onBlur(e), s.cancelFocusInput(), s.setOpen(!1));
          }),
          (s.setSelected = function(e, t, n) {
            ...
            if (null !== r && B(r, s.props))
              (function(e) {
                ...
                s.setState({ inputValue: r, preSelection: r }));
            else {
